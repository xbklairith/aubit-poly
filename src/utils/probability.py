...
def arbitrage_profit(
    ...
    """
    Calculate arbitrage profit for a binary market.
    ...
    Returns:
        Tuple of (profit, yes_allocation, no_allocation)
    """
    ...
    profit = profit_per_dollar * total_investment

    # Equal allocation for guaranteed profit
    yes_allocation = total_investment / Decimal("2")
    no_allocation = total_investment / Decimal("2")

    return profit, yes_allocation, no_allocation
