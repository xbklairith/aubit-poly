...
class ArbitrageEngine:
    ...
    async def _fetch_polymarket_markets(self) -> list[Market]:
        ...
        try:
            return await self.polymarket.get_markets(limit=200)
        except Exception as e:
    ...
    async def _fetch_kalshi_markets(self) -> list[Market]:
        ...
        try:
            return await self.kalshi.get_markets(limit=200)
        except Exception as e:
    ...
    async def _run_hedging_detection(
        ...
        # Only use Polymarket for hedging (most liquid)
        polymarket_markets = markets_by_platform.get(Platform.POLYMARKET, [])
        return await self.hedging_detector.scan(polymarket_markets)
