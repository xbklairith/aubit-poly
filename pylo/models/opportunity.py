...
class ArbitrageOpportunity(BaseModel):
    ...
    # Profit metrics
    profit_percentage: Decimal  # e.g., 0.02 = 2% (gross, before fees)
    profit_after_fees: Decimal = Decimal("0")  # Net profit after platform fees
    profit_absolute: Decimal | None = None  # Absolute profit for given size
    recommended_size: Decimal | None = None
    estimated_fees: Decimal = Decimal("0")  # Total estimated fees
