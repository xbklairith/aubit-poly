...
class DiscordNotifier(BaseNotifier):
    ...
    def __init__(self, webhook_url: str | None = None) -> None:
        ...
        # Get secret value for actual URL
        self.webhook_url = (
            webhook_url or self.settings.discord_webhook_url.get_secret_value()
        )
...
class TelegramNotifier(BaseNotifier):
    ...
    def __init__(
        ...
        self.settings = get_settings()
        # Get secret value for token
        self.bot_token = (
            bot_token or self.settings.telegram_bot_token.get_secret_value()
        )
